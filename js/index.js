...
gsap.from('.services-container',{duration:1,ease:'linear',y:"20%",scrollTrigger:{
...
gsap.from('#approach-img',{duration:1,delay:2,ease:"linear",x:"100%",scrollTrigger:{
            trigger:"#approach-img",
            toggleActions:"restart none restart none"
        }
    }
)
gsap.from('#approach-bd',{duration:1,delay:2,ease:"linear",x:"-100%",scrollTrigger:{
            trigger:"#approach-bd",
            toggleActions:"restart none restart none"
        }
    }
